...
if socket.gethostname() == 'soltani-server':
	path = '/backup2/DataSet/CIS/iscxIDS2017/pcap/'
...
# data_str += '?' + path + classes_config['attack_webattacks']['path']

# data_str = path + classes_config['Benign_Wednesday']['path']
# data_str += '?' + path + classes_config['DOS_SlowHttpTest']['path']
# data_str += '?' + path + classes_config['DOS_SlowLoris']['path']
# data_str += '?' + path + classes_config['DOS_Hulk']['path']
# data_str += '?' + path + classes_config['DOS_GoldenEye']['path']
...
class DataController(object):
	...
	def get_label_from_name(self, filename):
		...
		# 	print(classes_config[clas]['label'])
		# if filename.__contains__('BENIGN'):
		# 	return 0
		# elif filename.__contains__('attack_bot'):
		# 	return 1
		# elif filename.__contains__('attack_DDOS'):
		# 	return 2
		# elif filename.__contains__('attack_portscan'):
		# 	return 3
		# elif filename.__contains__('attack_webattacks'):
		# 	return 4
		# elif filename.__contains__('attack_infilteration'):
		# 	return 5
		# elif filename.__contains__('dos_slowhttptest'):
		# 	return 6
		# elif filename.__contains__('dos_slowloris'):
		# 	return 7
		# elif filename.__contains__('dos_hulk'):
		# 	return 8
