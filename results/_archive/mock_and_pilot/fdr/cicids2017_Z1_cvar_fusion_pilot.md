...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| hedl | 0.5 | 0.0334 | 0.2281 | 236.03 | 1.000 | 3 |
| hedl | 0.25 | 0.0022 | 0.0072 | 3.86 | 0.035 | 3 |
...
| --- | --- | ---: | ---: | --- | --- | --- |
| hedl | marginal | 0.0237 | 0.0110 | rejected | not_deployable | held_out_known_superuniformity_rejected, zero_unknown_detection_power, mostly_abstains |
| hedl | mondrian | 0.0152 | 0.0110 | rejected | not_deployable | held_out_known_superuniformity_rejected, zero_unknown_detection_power, mostly_abstains |
